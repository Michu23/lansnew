class BackgroundElements {
  render() {
    return `
      ...
      <img
        ...
        class="position-absolute w-100 h-100 ${styles.overlay}"
      />
      <div class="${styles.blueCircle}">
        ${this.renderBlueCircleSVG()}
      </div>
      <div class="${styles.waveLine}">
        ${this.renderWaveLineSVG()}
      </div>
    `;
  }

  renderBlueCircleSVG() {
    return `<svg width="788" height="858" viewBox="0 0 788 858" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  renderWaveLineSVG() {
    return `<svg width="1320" height="670" viewBox="0 0 1320 670" fill="none" xmlns="http://www.w3.org/2000/svg">
